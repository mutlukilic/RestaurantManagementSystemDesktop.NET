        ...
        private void frmMasalar_Load(object sender, EventArgs e)
        {
            ...
            while (dr.Read())
            {
                foreach(Control item in this.Controls)
                {
                    if (item is Button)
                    {
                        if (item.Name == "btnMasa" + dr["ID"].ToString() && dr["State"].ToString() == "1")
                        {
                            item.BackgroundImage = (System.Drawing.Image)(Properties.Resources.bos);
                        }
                        else if(item.Name == "btnMasa"+dr["ID"].ToString() && dr["State"].ToString() == "2")
                        {
                        ...
                        else if(item.Name == "btnMasa" + dr["ID"].ToString() && dr["State"].ToString() == "3")
                        {
                            item.BackgroundImage = (System.Drawing.Image)(Properties.Resources.acikrezerve);
                        }
                        else if (item.Name == "btnMasa" + dr["ID"].ToString() && dr["State"].ToString() == "4")
                        {
